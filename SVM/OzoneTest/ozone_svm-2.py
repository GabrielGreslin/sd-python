...
# Configuration
# kernel belong to ('linear', 'rbf', 'poly')
kernel = 'linear'
...
def builtX(data):
    ...
    for i,x in enumerate(data):
        ...
        #print(i)
        #print(line[5])
        line[4] = math.log(line[4])
        line[5] = math.log(line[5])
        X[i,:] = line
...
# Generate model
# kernel belong to 'linear', 'rbf', 'poly'
svc = svm.SVC(class_weight="balanced",C=0.45,kernel = kernel)#{True:"balanced",False:"balanced"})
